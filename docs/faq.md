...
if you are using a Chromium-based browser (Chrome, Edge, Brave, etc.), you can easily install ShareGlimmer PWA on your desktop 
by clicking the install-button in the top-right corner while on [ShareGlimmer.net](https://ShareGlimmer.net).
...
See [this host your own section](https://github.com/schlagmichdoch/ShareGlimmer/blob/master/docs/host-your-own.md#testing-pwa-related-features) for more information. 
...
Here's a list of some third-party apps compatible with ShareGlimmer:
...
If your devices are paired and behind a NAT, the ShareGlimmer TURN Server is used to route your files and messages. See the [Technical Documentation](technical-documentation.md#encryption-webrtc-stun-and-turn) to learn more about STUN, TURN and WebRTC.

If you host your own instance and want to support devices that do not support WebRTC, you can [start the ShareGlimmer instance with an activated Websocket fallback](https://github.com/schlagmichdoch/ShareGlimmer/blob/master/docs/host-your-own.md#websocket-fallback-for-vpn).
...
Files are sent directly between peers. ShareGlimmer doesn't even use a database. If you are curious, have a look [at the Server](https://github.com/schlagmichdoch/ShareGlimmer/blob/master/index.js).
...
<details>
<summary style="font-size:1.25em;margin-top: 24px; margin-bottom: 16px; font-weight: var(--base-text-weight-semibold, 600); line-height: 1.25;">
    Snapdrop and ShareGlimmer are awesome! How can I support them? 
</summary>

* [Buy me a coffee](https://www.buymeacoffee.com/ShareGlimmer) to pay for the domain and the server, and support open source software
* [File bugs, give feedback, submit suggestions](https://github.com/schlagmichdoch/ShareGlimmer/issues)
* Share ShareGlimmer on social media.
